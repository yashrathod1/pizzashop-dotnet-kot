$(document).ready(function () {
    ...
    console.log("firstcategory is", firstCategory);

    // Add active class to the first category and its associated sidebar link
    firstCategory.addClass("selected");
    firstCategory.find(".category-sidebar").addClass("selected");
...
$(document).on("click", ".edit-item", function () {
    ...
    $.ajax({
        ...
        success: function (item) {
            ...
            $("#ItemImagePathEdit").val(item.itemImagePath);

            console.log("item photo before update", item.itemImagePath);
        ...
        if ($("#addMenuItemForm").length > 0) {
            $(".modifier-group").each(function (index) {
                ...
                if (minQuantity > maxQuantity) {
                    ...
                    toastr.error("select Min and Max Quantity");
                    minInput.addClass("is-invalid");
                    maxInput.addClass("is-invalid");
                    isValid = false;
                } else {
...
$("#editMenuItemForm").submit(function (e) {
    ...
    console.log("itemphoto is", itemPhoto);
...
$(document).on("change", ".allmodifier-checkbox", function () {
    ...
    console.log("dfsjdf", selectedModifiers);
});
...
$("#addModifiersBtn").on("click", function () {
    ...
    console.log("modifer id for add", selectedModifiers);
