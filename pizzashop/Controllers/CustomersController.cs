...
public class CustomersController : Controller
{
    ...
    {
        var customer = await _customersService.GetCustomersAsync(pageNumber, pageSize, sortBy, sortOrder, searchTerm, dateRange, customStartDate, customEndDate);
    ...
    public async Task<IActionResult> GetCustomerHistory(int customerId)
    {
        ...
        var customerHistory = await _customersService.GetCustomerHistoryAsync(customerId);
