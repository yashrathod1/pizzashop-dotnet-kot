...
public class UsersController : Controller
{
    ...
    public async Task<IActionResult> UsersList()
    {
        ...
        var permission = await PermissionHelper.GetPermissionsAsync(HttpContext, "Users");
    ...
    public async Task<IActionResult> GetUsers(int pageNumber = 1, int pageSize = 5, string sortBy = "Name", string sortOrder = "asc", string searchTerm = "")
    {
        var permission = await PermissionHelper.GetPermissionsAsync(HttpContext, "Users");
        ViewBag.Permissions = permission;
        var pagedItems = await _userService.GetUsersAsync(pageNumber, pageSize, sortBy, sortOrder, searchTerm);
