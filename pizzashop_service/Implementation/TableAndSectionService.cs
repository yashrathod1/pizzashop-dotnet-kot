...
public class TableAndSectionService : ITableAndSectionService
{
    ...
    public async Task<Section> AddSectionAsync(string name, string description)
    {
        ...
        var existingSection = await _tableAndSectionRepository.GetSectionByNameAsync(name.Trim());
    ...
    {
        var section = await _tableAndSectionRepository.GetSectionByNameAsync(name);
    ...
    {
        var table = await _tableAndSectionRepository.GetTableByNameAsync(name);
